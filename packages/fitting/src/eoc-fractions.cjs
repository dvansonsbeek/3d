...
const refDataPath = path.join(ROOT, 'data', 'reference-data.json');
...
// (Four dead correlation-input arrays — fracs/eccs/sinDws/periods — were
// deleted at 9-3g when the file joined the linted scope; the correlation
// printout below computes its own inputs. Git history preserves them.)
