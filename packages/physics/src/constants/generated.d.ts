...
export declare const CONSTANTS_HASH: "7940c564f7b5f0a6";
...
export declare const DEFAULT_CONSTANTS: {
  readonly hash: "7940c564f7b5f0a6";
...
export declare const REFERENCE_DATA: {
  ...
  readonly laplaceLagrangeBounds: {
    "mercury": [number, number];
    "venus": [number, number];
    "earth": [number, number];
    "mars": [number, number];
    "jupiter": [number, number];
    "saturn": [number, number];
    "uranus": [number, number];
    "neptune": [number, number];
  };
