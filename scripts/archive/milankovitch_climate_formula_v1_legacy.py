#!/usr/bin/env python3
"""
MILANKOVITCH 8H CLIMATE FORMULA — V1 LEGACY (25 components, single-layer)
==========================================================================
...
Run:  python3 scripts/milankovitch_climate_formula_v1_legacy.py
Output: data/milankovitch-climate-formula-v1-legacy.json
"""
...
OUT_PATH = DATA_DIR / "milankovitch-climate-formula-v1-legacy.json"
