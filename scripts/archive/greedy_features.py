...
COEFFS_FILES = {
    'mercury': 'coefficients.mercury_coeffs_unified',
    'venus':   'coefficients.venus_coeffs_unified',
    'mars':    'coefficients.mars_coeffs_unified',
    'jupiter': 'coefficients.jupiter_coeffs_unified',
    'saturn':  'coefficients.saturn_coeffs_unified',
    'uranus':  'coefficients.uranus_coeffs_unified',
    'neptune': 'coefficients.neptune_coeffs_unified',
}
