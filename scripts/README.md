...
These scripts were used during the research to discover and verify the six Fibonacci Laws that connect planetary orbital tilts, eccentricities, and precession rates to the Holistic-Year timescale (H; see [Constants Reference](../20-constants-reference.md)).
...
The predictive formula library and training scripts have moved:

| Location | Contents |
|----------|----------|
| [`tools/lib/python/`](../tools/lib/python/README.md) | `predictive_formula.py`, `observed_formula.py`, `coefficients/`, `predict_precession.py`, `validate_precession.py`, `PREDICTIVE_FORMULA_GUIDE.mdx` |
| [`tools/fit/python/`](../tools/fit/README.md) | `train_precession.py`, `train_observed.py`, `greedy_features.py` |
...
| File | Description |
|------|-------------|
| [`../data/01-holistic-year-objects-data.xlsx`](../data/01-holistic-year-objects-data.xlsx) | Excel data file with multiple sheets: 'Perihelion Planets' (planet perihelions, fluctuations, Earth eccentricity/obliquity), 'Earth Longitude' (Earth Longitude RA), and more. All scripts read from this file. |
