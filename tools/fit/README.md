...
| `../../tools/fit/validate-resonator.js` | `data/core-mantle-resonator-stage3-validation.json` — runtime OFF/ON sweep: J2000 invariants, Stephenson RMS 268.8 → 53.4 s, Espenak window +0.4 s, deep-time bit-identical ±200 Myr. | production chain (`tools/lib/deep-time.js`) |
