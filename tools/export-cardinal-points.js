 ...
 *
 * Usage:
 *   node tools/export-cardinal-points.js [--step 29] [--output docs/97-Holistic_cardinal_points.csv]
 *
 * Outputs:
...
const OUTPUT_CSV = getArg('output', path.join(__dirname, '..', 'docs', '97-Holistic_cardinal_points.csv'));
const OUTPUT_JSON = path.join(__dirname, 'cardinal-points-training.json');
