...
const ECLIPSE_PRESETS = [
  ...
  { jd: 2154000.058445, label: '1185 May 1 Total' },
  { jd: 2135100.002430, label: '1133 Aug 2 Total' },
  { jd: 2087792.051441, label: '1004 Jan 24 Hybrid' },
  { jd: 2083982.839931, label: '993 Aug 20 Total' },
  { jd: 2081030.093891, label: '985 Jul 20 Total' },
  ...
  { jd: 1747068.890110, label: '71 Mar 20 Hybrid' },
  ...
  { jd: 1518118.032841, label: '-556 May 19 Total' },
  { jd: 1507900.104145, label: '-584 May 28 Total' },
  { jd: 1484836.848499, label: '-647 Apr 6 Total' },
...
const SITES = new Map([
  ...
  [2087792.051441, { name: 'Cairo record (Ibn Yunus)', lat: 30.05, lon: 31.24 }],
  [2083982.839931, { name: 'Cairo record (Ibn Yunus)', lat: 30.05, lon: 31.24 }],
  [2081030.093891, { name: 'Cairo record (Said)', lat: 30.05, lon: 31.24 }],
  [2078785.134930, { name: 'Cairo record (Said)', lat: 30.05, lon: 31.24 }],
  [2078431.006474, { name: 'Cairo record (Said)', lat: 30.05, lon: 31.24 }],
  [2078253.853718, { name: 'Cairo record (Ibn Yunus)', lat: 30.05, lon: 31.24 }],
