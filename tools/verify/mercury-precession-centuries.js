...
console.log('');
console.log('  Earth\'s inclination precession:    1/3 of Holistic Year   (111,772 years)');
console.log('  Earth\'s ecliptic precession:       1/5 of Holistic Year   (67,063 years)');
console.log('');
