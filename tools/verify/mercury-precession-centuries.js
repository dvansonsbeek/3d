// ═══════════════════════════════════════════════════════════════════════════
// APPENDIX G (86): MERCURY PERIHELION PRECESSION BY CENTURY
// ═══════════════════════════════════════════════════════════════════════════
//
...
const earthAxialPrecessionPeriod = holisticyearLength / 13;        // ~25,794 years
const earthObliquityPeriod = holisticyearLength / 8;               // ~41,915 years
const earthInclinationPrecessionPeriod = holisticyearLength / 3;   // ~111,772 years
const earthEclipticPrecessionPeriod = holisticyearLength / 5;      // ~67,063 years

// Dominant fluctuation period (beat frequency between Earth's cycles)
const dominantFluctuationPeriod = holisticyearLength / 45;         // ~7,451 years
...
console.log('╔═══════════════════════════════════════════════════════════════════════════╗');
console.log('║     APPENDIX G (86): MERCURY PERIHELION PRECESSION BY CENTURY                 ║');
console.log('╠═══════════════════════════════════════════════════════════════════════════╣');
...
console.log('├─────────────────────────────────────────────────────────────────────────────┤');
console.log(`│ Earth Fundamental Cycle:                      ${holisticyearLength.toFixed(0).padStart(12)} years                │`);
...
console.log('  └── earth');
console.log('        └── earthInclinationPrecession      ← 111,772 year cycle');
...
console.log('  - It averages to ZERO over ~334,000 years (one Earth Fundamental Cycle)');
...
console.log('═══════════════════════════════════════════════════════════════════════════');
console.log('');
console.log('  docs/12-perihelion-precession.md - Full documentation');
console.log('  docs/13-mercury-precession-breakdown.md - Mercury analysis');
