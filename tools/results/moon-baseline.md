...
**Historical snapshot** — the `moonStartpos*` values below were later superseded by J2000-element anchoring (docs/66 §4). **Current certified baseline (post D5 derived optics): RMS Total 0.0012° (RA 0.0009 / Dec 0.0008)** — see `all-baselines-summary.md`.
...
| `moonApsidalPrecessionDaysInputICRF` | 3231.493 | Meeus ≈ 8.8475 yr, EQUINOX-OF-DATE (legacy-'ICRF' name) — Option C+ 2026-06 |
| `moonNodalPrecessionDaysInputICRF`   | 6798.38  | Meeus ≈ 18.6133 yr, equinox-of-date (legacy-'ICRF' name) — Option C+ 2026-06 |
