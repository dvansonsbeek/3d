...
**Ascending node precession is already implemented**: The ascending nodes precess over time and this is already calculated dynamically using `<planet>PerihelionICRFYears` constants in `updatePlanetInvariablePlaneHeights()`:
- Earth: ~99,392 years (`holisticyearLength/3`)
- Jupiter: ~59,635 years (`holisticyearLength/5`)
- Saturn: ~-37,272 years (`-holisticyearLength/8`, retrograde)
