...
Consolidates 2 scripts into one comprehensive analysis:
  ...
  1. Earth's ecliptic-frame geometry over 333,888 years
...
print("=" * 100)
print("§1 — EARTH'S ECLIPTIC-FRAME GEOMETRY OVER 333,888 YEARS")
print("=" * 100)
...
print(f"""
  CORE FINDING:
    ...
    for ALL {n_valid} data points across the full 333,888-year Holistic cycle.
