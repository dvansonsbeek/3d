...
Sections:
  ...
  2. Full 8-planet prediction chain from e_E = 0.015321 (1 free param)
...
print("\n" + "=" * 78)
print("Section 2: Full 8-planet prediction chain from e_E = 0.015321")
print("=" * 78)
...
print(f"\n  Scenario A: e_E = 0.015321 as reference (1 free parameter)")
