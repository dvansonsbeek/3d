...
The 0.12% gap between the observed balance (99.88%) and perfect balance traces to Saturn's J2000 eccentricity (0.05386) being 0.24% above the Law 5 prediction (0.05373). Saturn's eccentricity oscillates secularly between ~0.01 and ~0.09; the Law 5 prediction represents the value at which the eccentricity balance is exact. See [Appendix N — Eccentricity Balance](appendix-n-eccentricity-balance.js) for the static analysis.
