...
| Planet | Inclination | Relation to Earth Mean | Crossover Possible? |
|--------|-------------|------------------------|---------------------|
| Mercury | 7.005° | ABOVE | No |
| Venus | 3.395° | ABOVE | No |
| Mars | 1.850° | ABOVE | **Yes** (within range) |
| Jupiter | 1.305° | BELOW | **Yes** (within range) |
| Saturn | 2.485° | ABOVE | No |
| Uranus | 0.772° | BELOW | No |
| Neptune | 1.768° | ABOVE | **Yes** (within range) |
| Pluto | 17.142° | ABOVE | No |
...
3. **Inclination crossover**: Only affects planets within Earth's inclination range (Jupiter, Mars, Neptune)
...
- [Dynamic Inclination to Ecliptic Calculation](dynamic-inclination-to-ecliptic-calculation-Souami&Souchay.md) - Ecliptic inclination formula
