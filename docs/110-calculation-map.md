...
| 0.002584 | 27.321651 | 8.84907 | 18.59837 | 335316.8 | 1.0001477 | 1.0000625 |
| 0.01 | 27.321621 | 8.84654 | 18.59613 | 335316.4 | 1.0004353 | 1.0001841 |
| 0.1 | 27.321253 | 8.82099 | 18.57354 | 335309.0 | 1.0033466 | 1.0014140 |
| 1 | 27.317580 | 8.81322 | 18.56805 | 335235.1 | 1.0043663 | 1.0018443 |
| 10 | 27.280854 | 8.78496 | 18.55722 | 334495.6 | 1.0089493 | 1.0037752 |
| 380 | 25.771659 | 9.38690 | 19.72031 | 306189.4 | 0.9994087 | 0.9997499 |
| 650 | 24.643977 | 9.81344 | 20.61884 | 287384.3 | 0.9996124 | 0.9998361 |
<!-- /generated:calcmap-lunar-periods -->
...
| 5 | **H(t)** | **H_J2000 · LOD(t)/LOD_J2000** — "the H/13 identity": the precession period scales as 1/ω, and H is 13 of those periods | H_J2000 = 335,317 (the fitted primitive), LOD_J2000 = 86,399.99968 s (the kinematic day) | **P** — H(t) IS ω(t) by proxy; the J2000 value is **U** | `deltat/deep-time.cjs` 105–109 |
| 6 | structural precession period | H(t)/13; structural rate ψ̇_struct = 1,296,000/(H(t)/13) = p₀·ω/ω₀ | step 5 | **U** (the 13) | registry `earthPrecStructural*` |
| 7 | tropical year of age | T_sid(t) · (1 − 13/H(t)) — one precession per H/13 | step 5; T_sid(t) = T₀(1 − Δm)² (Driver 2) | **P** (13/H = the precession-per-year) | `deltat/deep-time.cjs` 113–134 |

What plan 06 restates here is only step 5's *name*: H(t) = 13·⟨T_p⟩(t) with
⟨T_p⟩(t) = T_p,J2000 · LOD(t)/LOD_J2000 the mean luni-solar precession period
on the tidal tier. Nothing numeric moves.
...
| the hybrid's own α(t) at deep time | — | — | **P**: α(t) = ψ̇(t)/cos ε₀ with ψ̇(t) = 2π/(T_p,J2000 · H(t)/H₀) — H(t) as ω(t) | `model.js` 518–522; `deep-orbital-history.cjs` 192–200 |
...
|---|---|---|---|---|---|---|---|---|---|
| 0 | 384399 | 24.000 | 1.00000 | 0.330695 | 335317 | 25793.6 | 50.24 | 1.0000 | 50.24 |
| 0.01 | 384399 | 24.000 | 1.00000 | 0.330695 | 335316 | 25793.6 | 50.25 | 1.0000 | 50.25 |
| 0.1 | 384395 | 23.999 | 1.00002 | 0.330695 | 335309 | 25793.0 | 50.25 | 1.0000 | 50.25 |
| 1 | 384361 | 23.994 | 1.00024 | 0.330695 | 335235 | 25787.3 | 50.26 | 1.0003 | 50.27 |
| 10 | 384017 | 23.941 | 1.00246 | 0.330695 | 334496 | 25730.4 | 50.37 | 1.0030 | 50.47 |
| 100 | 380577 | 23.423 | 1.02464 | 0.330695 | 327253 | 25173.3 | 51.48 | 1.0304 | 52.55 |
| 380 | 369749 | 21.915 | 1.09513 | 0.330695 | 306189 | 23553.0 | 55.02 | 1.1236 | 59.68 |
| 650 | 358901 | 20.569 | 1.16679 | 0.330695 | 287384 | 22106.5 | 58.63 | 1.2286 | 67.79 |
...
|---|---|---|---|---|---|---|---|
| -10000 | 26293.32 | 49.2901 | 26274.84 | 49.3248 | 18.48 | 25793.6 | 24.15915 |
...
| 10000 | 25342.66 | 51.1391 | 25167.93 | 51.4941 | 174.73 | 25793.7 | 22.65355 |
<!-- /generated:calcmap-ofdate-precession -->
...
2. **The physical rate has no home in the physics package.** The
   composition (2.3) is computed in the registry and an explore script;
   the package exposes only the of-date beat (`axialPrecessionYearsAtYear`)
   and the structural H(t). Plan 06 Phase 3's `lunisolar` surface is where
   it belongs — this chain is its specification.
3. **H(t)'s deep-time content is ω(t) and nothing else** (2.1 step 5): the
   structural clock scales with the day length only; the composition adds
   the lunar 1/a³ term, and at 650 Ma that is the difference between
   58.6 and 67.8 ″/yr against Wu's 67.64. Every "spin-family period scales
   with H(t)" statement in the docs is, physically, "scales with the day
   length" — the restatement writes it that way.
4. **The α(t) step carries a comb** (2.1 step 2, role C): the
   ...
   consumers.
5. **Two of-date precession evaluators, one name.** Route (A) (the comb
   pair) and route (B) (the one-family hybrid route) are both called "the
   axial precession of date", agree at J2000 by anchoring, and differ by
   0.07 % at −10 kyr and 0.7 % at +10 kyr (table 2.4). The owner's panel
   reading at −10 kyr (26,462 yr) is a third value again. Route (B) is the
   physics (the spin integrated against the engine's orbit); route (A) is
   the certified era device (combs fitted to the scene's own geometry).
   Plan 06 Phase 3 must make ONE of them the published T_p(t) and label the
   other as the era device — the one-family rule this factory was built
   for ("a displayed rate must name its window"), applied to its own beat.
   Both are now pinned in the plan-06 baseline fixture.
...
|---|---|---|---|---|---|---|---|
| -10000 | 365.257068 | 365.256351 | 365.243177 | 365.243177 | 365.242450 | 365.260336 | 365.259119 |
| -2584 | 365.256679 | 365.256357 | 365.242668 | 365.242668 | 365.242392 | 365.259949 | 365.259444 |
| -584 | 365.256547 | 365.256360 | 365.242470 | 365.242470 | 365.242314 | 365.259817 | 365.259527 |
| 0 | 365.256507 | 365.256361 | 365.242409 | 365.242408 | 365.242288 | 365.259777 | 365.259551 |
| 1246 | 365.256418 | 365.256362 | 365.242274 | 365.242274 | 365.242228 | 365.259688 | 365.259604 |
| 2000 | 365.256363 | 365.256363 | 365.242190 | 365.242190 | 365.242190 | 365.259633 | 365.259637 |
| 5000 | 365.256122 | 365.256365 | 365.241838 | 365.241838 | 365.242040 | 365.259392 | 365.259781 |
| 10000 | 365.255630 | 365.256373 | 365.241217 | 365.241217 | 365.241860 | 365.258898 | 365.260136 |
...
|---|---|---|---|---|---|---|---|
| -10000 | 86399.83298 | 86399.81162 | -21.358 | 86163.9246 | 86163.9329 | 86399.83290 | 86399.83331 |
| -2584 | 86399.92510 | 86399.91231 | -12.796 | 86164.0161 | 86164.0245 | 86399.92473 | 86399.92543 |
| -584 | 86399.95645 | 86399.94662 | -9.838 | 86164.0473 | 86164.0556 | 86399.95604 | 86399.95678 |
| 0 | 86399.96599 | 86399.95674 | -9.256 | 86164.0568 | 86164.0651 | 86399.96557 | 86399.96632 |
| 1246 | 86399.98696 | 86399.97841 | -8.554 | 86164.0776 | 86164.0859 | 86399.98653 | 86399.98728 |
| 2000 | 86400.00011 | 86399.99160 | -8.508 | 86164.0906 | 86164.0990 | 86399.99968 | 86400.00043 |
| 5000 | 86400.05707 | 86400.04621 | -10.866 | 86164.1472 | 86164.1556 | 86400.05669 | 86400.05740 |
| 10000 | 86400.17355 | 86400.15608 | -17.469 | 86164.2630 | 86164.2714 | 86400.17336 | 86400.17388 |
<!-- /generated:calcmap-day-lengths -->
...
2. **The (A)/(B) family split is the same finding as chain 2's finding 5**,
   seen from the years instead of the beat: at ±10 kyr the two sidereal
   years differ by ~0.7 ms/day-equivalent (365.257068 vs 365.256351 d at
   −10 kyr) — invisible in-era, decisive for which T_p(t) is published.
...
| -28000 | 22.23032 | 23.47788 | 22.22990 | -4491 | 2 | 4493 |
...
| 380 | 23553.032 | 23553.032 | 55.025 | 59.675 | 35.83 | 31.75 | 38.27 |
| 650 | 22106.487 | 22106.487 | 58.625 | 67.787 | 32.58 | 26.48 | 35.92 |
| 1400 | 19863.706 | 19863.706 | 65.245 | 86.521 | 27.93 | 19.15 | 32.28 |
| 2460 | 18277.494 | 18277.494 | 70.907 | 104.511 | 24.90 | 15.13 | 29.70 |
...
|---|---|---|---|---|---|---|---|---|---|
| -10000 | -4382906.2754 | 0.02151 | -2.17476 | -0.15117 | 0.11758 | 0.00306 | -4382908.45917 | 0.8727114 | 0.8727115 |
| -2584 | -1674270.1972 | 0.00702 | -0.38503 | -0.06334 | 2.48830 | -0.00072 | -1674268.15098 | 0.8948279 | 0.8948279 |
...
| 10000 | 2921937.5169 | -0.00868 | -1.08615 | -0.13416 | -0.14045 | 0.00041 | 2921936.14790 | 0.9323565 | 0.9323565 |
...
|---|---|---|---|---|---|---|---|---|---|
| -10000 | -10000 03-26 04:41 | -10000 06-22 14:47 | -10000 09-19 23:16 | -10000 12-23 04:45 | 365.243182 | 365.243888 | 365.243177 | 31556948.62 | 0.02124 |
| -2584 | -2584 03-22 17:13 | -2584 06-24 22:11 | -2584 09-23 03:24 | -2584 12-20 14:25 | 365.242045 | 365.242363 | 365.242668 | 31556943.15 | 0.01863 |
| -584 | -584 03-21 11:34 | -584 06-23 15:59 | -584 09-23 15:32 | -584 12-21 03:06 | 365.241726 | 365.241912 | 365.242470 | 31556936.14 | 0.01781 |
| 0 | 0 03-20 20:09 | 0 06-22 19:36 | 0 09-23 06:31 | 0 12-20 22:45 | 365.241670 | 365.241816 | 365.242408 | 31556933.80 | 0.01756 |
...
| 5000 | 5000 03-20 20:11 | 5000 06-19 06:55 | 5000 09-20 23:57 | 5000 12-22 03:20 | 365.241899 | 365.241659 | 365.241838 | 31556912.12 | 0.01541 |
| 10000 | 10000 03-19 19:40 | 10000 06-17 05:21 | 10000 09-16 01:06 | 10000 12-18 06:42 | 365.242381 | 365.241648 | 365.241217 | 31556895.91 | 0.01326 |
