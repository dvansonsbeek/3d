...
| Feature | Description |
|---------|-------------|
| **Fifteen categories** | Eccentricity, obliquity, inclination (inv. plane), ascending node (inv. plane), perihelion longitude, tropical year, cardinal year lengths, solar day, sidereal year, axial precession, ΔT (TT − UT1), plus the two all-planet panels, the All Precession Periods panel and the Analemma panel below |
| **Four standard windows** | Every generic category shows the same tab strip — 1650 → 2050 AD · 23,000 BC → 23,000 AD (default) · 250,000 BC → 100,000 AD · 1,000,000 BC → 1,000,000 AD — sampled 200 / 240 / 400 / 800 points so the 41-kyr obliquity cycle keeps ≥ 10 points per cycle at ±1 Myr; ΔT keeps two windows only (1650 → 2050 and the Espenak canon's 2000 BC → 3000 AD) |
...
| **Residual chart** | `reference − model` inside validity, in arcseconds, seconds, milliseconds, degrees or the dimensionless eccentricity depending on the category |
