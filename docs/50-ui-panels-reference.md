...
| Feature | Description |
|---------|-------------|
| **Fourteen categories** | Eccentricity, obliquity, inclination (inv. plane), ascending node (inv. plane), perihelion longitude, tropical year, cardinal year lengths, solar day, sidereal year, axial precession, ΔT (TT − UT1), plus the two all-planet panels and the All Precession Periods panel below |
