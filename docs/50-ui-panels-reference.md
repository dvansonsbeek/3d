...
| Feature | Description |
|---------|-------------|
| **Twenty-two categories, six groups** | The dropdown carries group headers in the order the physics builds up, and the header title reads "group · panel": **Earth orbit** — Eccentricity, Perihelion Longitude, Inclination (invariable plane), Ascending Node (invariable plane); **Earth axis** — Obliquity, Axial Precession Period; **Earth cycles** — Precession Periods (all five), Climatic Precession (e·sin ϖ), Summer Insolation (65°N), Milankovitch Overview, Analemma; **Earth clock** — Tropical Year, Sidereal Year, Anomalistic Year, Cardinal Year Lengths, Season Durations, Solar Day Length, ΔT (TT − UT1); **Moon** — Perigee Precession, Node Regression; **All planets** — Inclination, Eccentricity |
