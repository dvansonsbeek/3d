...
| Feature | Description |
|---------|-------------|
| **Nineteen categories, five groups** | The dropdown carries group headers in the order the physics builds up, and the header title reads "group · panel": **Earth orbit** — Eccentricity, Perihelion Longitude, Inclination (invariable plane), Ascending Node (invariable plane); **Earth axis** — Obliquity, Axial Precession Period; **Earth cycles** — Precession Periods (all five), Climatic Precession (e·sin ϖ), Summer Insolation (65°N), Milankovitch Overview, Analemma; **Earth clock** — Tropical Year, Sidereal Year, Cardinal Year Lengths, Season Durations, Solar Day Length, ΔT (TT − UT1); **All planets** — Inclination, Eccentricity |
...
| **Earth-only elsewhere** | The fifteen formula categories describe Earth's orbit + spin axis (+ ΔT); per-planet observational validation lives in the WebGeoCalc Explorer and the two all-planet panels |
