...
| Feature | Description |
|---------|-------------|
| **Fifteen categories, five groups** | The dropdown carries group headers in the order the physics builds up, and the header title reads "group · panel": **Earth orbit** — Eccentricity, Perihelion Longitude, Inclination (invariable plane), Ascending Node (invariable plane); **Earth axis** — Obliquity, Axial Precession Period; **Earth cycles** — Precession Periods (all five), Analemma; **Earth clock** — Tropical Year, Sidereal Year, Cardinal Year Lengths, Solar Day Length, ΔT (TT − UT1); **All planets** — Inclination, Eccentricity |
