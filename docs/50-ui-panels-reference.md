...
| **Caption** | The same five blocks on every panel — Frame · Model · References (with validity windows) · Reading (rms per reference over the visible window, the J2000 anchor) · Note — built from the category's own data; the former two-point endpoint-difference block is gone |
