...
> **Note**: This document records the starting baseline before any optimization was applied. For current baselines after EoC, parallax correction, and parameter optimization, run `node tools/optimize.js baseline all` or see [87-planet-parallax-corrections.md](87-planet-parallax-corrections.md) §5.
