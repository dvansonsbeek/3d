...
convention — current mean **<!--v:centerlinesMeanArcsec-->2.3<!--/v-->″** /
max **<!--v:centerlinesMaxArcsec-->6.7<!--/v-->″** shadow-plane (the VECTOR
...
part — the Moon's own law), while the cardinal-point path keeps the H/16
...
NASA centerlines mean <!--v:centerlinesMeanArcsec-->2.3<!--/v-->″ / max
<!--v:centerlinesMaxArcsec-->6.7<!--/v-->″; audit verdicts 3/13/5/0/5;
Babylon −135 BestGap <!--v:babylon135BestGapKm-->366<!--/v--> km
...
(<!--v:babylon135BestGapKm-->366<!--/v--> km, off-peak verdict, UT within
9 minutes; see
