...
λ 2.96 → <!--v:moonSeriesLonVsJplRms-->2.92<!--/v-->″,
β 0.65 → <!--v:moonSeriesLatVsJplRms-->0.61<!--/v-->″; the dense 2-day
...
reproduced, Babylon −135 stable at
<!--v:babylon135BestGapKm-->188<!--/v--> km. What remains of the 20.3h
floor verdict is the part FQ-7 did not touch: the beyond-3-body dust
(~1.3″) and the flat ~4″ analytic-vs-DE441 representational gap.
...
Sun 2.12″ / Moon λ 3.03″ / β <!--v:moonSeriesLatVsJplRms-->0.61<!--/v-->″ (the 20.3h round-2 Delaunay tail later
closed λ to 2.96″ and the FQ-7 J2 node family to
<!--v:moonSeriesLonVsJplRms-->2.92<!--/v-->″, moving β 0.65 → 0.61″); syzygy 3.82″; tracked centerlines
<!--v:centerlinesMeanArcsec-->2.4<!--/v-->″ mean, <!--v:centerlinesMaxArcsec-->5.6<!--/v-->″ max (current audit run, <!--v:centerlinesEvents-->14<!--/v--> events / <!--v:centerlinesPoints-->42<!--/v--> points).
