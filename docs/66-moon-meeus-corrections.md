...
max **<!--v:centerlinesMaxArcsec-->6.9<!--/v-->″** shadow-plane (the VECTOR
...
<!--v:centerlinesMaxArcsec-->6.9<!--/v-->″; audit verdicts 3/13/5/0/5;
Babylon −135 BestGap <!--v:babylon135BestGapKm-->372<!--/v--> km
...
(<!--v:babylon135BestGapKm-->372<!--/v--> km, off-peak verdict, UT within
9 minutes; see
