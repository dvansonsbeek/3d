...
convention — current mean **<!--v:centerlinesMeanArcsec-->2.6<!--/v-->″** /
max **<!--v:centerlinesMaxArcsec-->7.4<!--/v-->″** shadow-plane (the VECTOR
...
NASA centerlines mean <!--v:centerlinesMeanArcsec-->2.6<!--/v-->″ / max
<!--v:centerlinesMaxArcsec-->7.4<!--/v-->″; audit verdicts 3/13/5/0/5;
Babylon −135 BestGap <!--v:babylon135BestGapKm-->364<!--/v--> km
...
(<!--v:babylon135BestGapKm-->364<!--/v--> km, off-peak verdict, UT within
9 minutes; see
