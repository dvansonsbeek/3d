...
| BestΔUT (offset giving minimum umbra↔site distance) | <!--v:babylon135BestDeltaUT-->-0h60<!--/v--> |
| **BestGap (umbra↔site at BestΔUT)** | **<!--v:babylon135BestGapKm-->366<!--/v--> km** |
| Verdict | **off-peak** |
...
These sources establish the context every reconstruction shares: the eclipse's geographic placement at Babylon depends critically on Sun precision, the ΔT model, and the greatest-eclipse convention. Within that context the framework's prediction — BestGap <!--v:babylon135BestGapKm-->366<!--/v--> km within the scan window, UT within 9 minutes, deep-totality-boundary local circumstances at the site — places the traditional identification on solid footing.
