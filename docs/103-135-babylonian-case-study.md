...
| **BestGap (umbra↔site at BestΔUT)** | **<!--v:babylon135BestGapKm-->311<!--/v--> km** |
| Verdict | **off-peak** |
...
is <!--v:babylon135BestGapKm-->311<!--/v--> km. The components:
...
reductions is Δṅ ≈
<!--v:lunarTheoryDriftDeltaNdot-->0.30<!--/v--> ″/cy² ([doc 102](102-gia-alpha-lunar-validation.md)).
