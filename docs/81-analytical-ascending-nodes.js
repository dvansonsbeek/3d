// ═══════════════════════════════════════════════════════════════════════════
// APPENDIX B (81): ANALYTICAL ASCENDING NODE CALCULATION
// ═══════════════════════════════════════════════════════════════════════════
//
// COMPARISON WITH APPENDIX A (80):
// - Appendix A (80) uses NUMERICAL optimization (brute-force search)
// - Appendix B (81) uses ANALYTICAL calculation (closed-form formula)
...
//
// Run with: node 81-analytical-ascending-nodes.js
// ═══════════════════════════════════════════════════════════════════════════
...
// Our numerically optimized values (from Appendix A (80))
...
console.log('╔═══════════════════════════════════════════════════════════════════════════╗');
console.log('║     APPENDIX B (81): ANALYTICAL ASCENDING NODE CALCULATION                    ║');
console.log('╠═══════════════════════════════════════════════════════════════════════════╣');
