...
K = <!--v:kValue-->3.4143 × 10⁻⁶<!--/v--> — derived from Earth's mean parameters (obliquity = <!--v:meanObliquity-->23.41353<!--/v-->°, eccentricity amplitude = 0.0013559). This is the eccentricity analog of the ψ-constant for inclination amplitudes.
