...
| Metric | Mercury Example |
|--------|-----------------|
| Rate | Exactly 532.32 arcsec/century |
| Fluctuation | None |
...
The Earth-frame showing ~570 arcsec/century currently might be coincidental - we happen to be at a high point in the ~6,500 year fluctuation cycle. This is NOT the same as the relativistic anomaly.
...
- [mercury-perihelion-fluctuation-analysis.md](mercury-perihelion-fluctuation-analysis.md) - Detailed analysis of the fluctuation pattern
- [orbital-formulas.md](orbital-formulas.md) - Orbital mechanics calculations
- [precession-breakdown-implementation.md](precession-breakdown-implementation.md) - Earth precession layer documentation
