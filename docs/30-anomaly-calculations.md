...
Computes 10 dynamic `o.moon*` variables (Ω, ϖ, ω, ν, M, E, distance, phase angle, elongation, descending node). See [Section 1.4.2 of the Orbital Formulas Reference](21-orbital-formulas-reference.md) for the complete variable list.
