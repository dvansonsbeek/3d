...
| 103 | [-135 Babylonian solar eclipse case study](103-135-babylonian-case-study.md) | Focused case study of the -135 Apr 15 Babylonian eclipse. Framework places the umbra *centerline* at **BestGap ≈ 1,230 km** (−1h45 within the ±4h scan; audit-26 scan 1232 km), verdict **⚠ geographic (boundary)** — at the regional/geographic class boundary. The class gate is centerline distance, not visibility: at γ = 0.719 the penumbra still covers the site. Framework and record agree on the eclipse UT to within **16 minutes**. Component-level decomposition attributes the residual to Sun ecliptic-longitude drift, framework ΔT convention, and framework GMST convention. Meeus Ch. 47 Moon polynomial exonerated (all modern lunar theories converge within 0.001° at year -135) |
