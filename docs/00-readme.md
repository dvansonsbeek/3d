...
| 18 | [8H Super-Cycle Test + Fourteen Follow-Ups + 405-kyr Investigation](18-8h-super-cycle-test.md) | Pre-registered super-cycle hypothesis (does 8H pace deep-time geological events?) rejected on 20 ICS boundaries (§4) + complementary spectral nulls on CENOGRID (§4.5–§4.6). Fourteen follow-up tests A–N on framework predictions: 16 positive, 2 partials, 5 nulls. Dedicated §6 investigation characterises the 405-kyr empirical climate line as a Layer-2 carbon-cycle silicate-weathering resonance (δ¹³C/δ¹⁸O ratio 1.53) rather than an orbital cycle in this framework |
