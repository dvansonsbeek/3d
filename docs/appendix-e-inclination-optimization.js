...
const earthConfig = {
  omegaJ2000: 284.5304,                   // Verified ascending node = perihelion + 180° + incl
...
const planetInputs = {
  ...
  saturn: {
    ...
    phaseAngle: 23,                                 // 203 - 180 for retrograde
