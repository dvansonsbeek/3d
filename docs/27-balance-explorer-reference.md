...
This is Config #32 out of 755 valid configurations — the only one with mirror-symmetric d-assignments (Finding 2 in [Fibonacci Laws](26-fibonacci-laws.md#finding-2-configuration-uniqueness)).
