...
RMS values below are from the time of calibration (before parallax correction was extended). Current baselines are much lower — see [87-planet-parallax-corrections.md](87-planet-parallax-corrections.md) §5.
