# Tropical Year and Day Length Formula
...
| `holisticyearLength` (H) | See [Constants Reference](20-constants-reference.md) | Full holistic cycle |
| `balancedYear` | See [Constants Reference](20-constants-reference.md) | Reference year (1246 - 14.5 × H/16) |
...
| Parameter | Value | Description |
|-----------|-------|-------------|
| `eccentricityBase` | See [Constants Reference](20-constants-reference.md) | Base eccentricity |
| `eccentricityAmplitude` | See [Constants Reference](20-constants-reference.md) | Amplitude of variation |
...
| `11-length-day-year-formulas.md` | Update with final derived formula |
...
- Wobble radius: `r = eccentricityAmplitude` (see [Constants Reference](20-constants-reference.md))
...
|-----------|-------|--------|
| r (wobble radius) | `eccentricityAmplitude` | See [Constants Reference](20-constants-reference.md) |
...
|----------|-------|-------------|
| `meansolaryearlengthinDays` | See [Constants Reference](20-constants-reference.md) | Mean tropical year (days) |
| `meanlengthofday` | See [Constants Reference](20-constants-reference.md) | Mean solar day (seconds) |
| `earthtiltMean` | See [Constants Reference](20-constants-reference.md) | Mean obliquity |
...
| `meansolaryearlengthinDays` | See [Constants Reference](20-constants-reference.md) | Mean tropical year |
| `meansiderealyearlengthinDays` | See [Constants Reference](20-constants-reference.md) | Mean sidereal year |
| `meanlengthofday` | See [Constants Reference](20-constants-reference.md) | Mean solar day (derived) |
| `earthtiltMean` | See [Constants Reference](20-constants-reference.md) | Mean obliquity |
| `eccentricityDerivedMean` | √(eₘ² + a²) | Derived mean eccentricity |
