...
event-time offset accumulated over the <!--v:earthPeriPeriod-->20,936<!--/v-->-year (at J2000) perihelion precession cycle. (In the shipped model this content is carried by the `CARDINAL_POINT_ECC_TERMS` braid on the H/16 phase, not by literal H/16 sinusoids — see § "The equation-of-center content" above.)
...
through the cardinal points over the <!--v:earthPeriPeriod-->20,936<!--/v-->-year (at J2000) H/16 cycle.
