...
// GM = (2π)² × a³ / P² where a = AU in km, P = sidereal year in seconds
const GM_SUN = (4 * Math.PI * Math.PI * Math.pow(currentAUDistance, 3)) / Math.pow(meansiderealyearlengthinSeconds, 2);
   ...
   //    value : [ { v: () => o.predictedDeltatPerYear , dec:6, sep:',' },{ small: 'sec/ year' }]},
    ...
    null,
      ...
      {label : () => `Current orbital velocity`,
       ...
       hover : [`Instantaneous velocity from vis-viva equation: v = √(GM(2/r - 1/a)). Varies from ${fmtNum(OrbitalFormulas.perihelionVelocity(mercuryOrbitDistance * currentAUDistance, mercuryOrbitalEccentricity) * 3600, 0, ',')} km/h at perihelion to ${fmtNum(OrbitalFormulas.aphelionVelocity(mercuryOrbitDistance * currentAUDistance, mercuryOrbitalEccentricity) * 3600, 0, ',')} km/h at aphelion`]},
      {label : () => `Radial velocity (vᵣ)`,
       value : [ { v: () => OrbitalFormulas.radialVelocity(mercuryOrbitDistance * currentAUDistance, mercuryOrbitalEccentricity, o.mercuryTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
      ...
      {label : () => `Transverse velocity (vₜ)`,
       value : [ { v: () => OrbitalFormulas.transverseVelocity(mercuryOrbitDistance * currentAUDistance, mercuryOrbitalEccentricity, o.mercuryTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component perpendicular to radius: vₜ = √(GM/p) × (1 + e × cos(ν)). Always positive`]},
      {label : () => `Perihelion velocity (vₚ)`,
       value : [ { v: () => OrbitalFormulas.perihelionVelocity(mercuryOrbitDistance * currentAUDistance, mercuryOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Maximum orbital velocity at perihelion: vₚ = √(GM/a) × √((1+e)/(1-e))`]},
      {label : () => `Aphelion velocity (vₐ)`,
       value : [ { v: () => OrbitalFormulas.aphelionVelocity(mercuryOrbitDistance * currentAUDistance, mercuryOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Minimum orbital velocity at aphelion: vₐ = √(GM/a) × √((1-e)/(1+e))`]},
      {label : () => `Specific Orbital Energy (ε)`,
       value : [ { v: () => OrbitalFormulas.specificEnergy(mercuryOrbitDistance * currentAUDistance), dec:4, sep:',' },{ small: 'km²/s²' }],
       hover : [`Total mechanical energy per unit mass: ε = -GM/(2a). Negative for bound orbits`]},
      {label : () => `Specific Angular Momentum (h)`,
       value : [ { v: () => OrbitalFormulas.specificAngularMomentum(mercuryOrbitDistance * currentAUDistance, mercuryOrbitalEccentricity), dec:2, sep:',' },{ small: 'km²/s' }],
    ...
    null,
      ...
      {label : () => `Current orbital velocity`,
       ...
       hover : [`Instantaneous velocity from vis-viva equation: v = √(GM(2/r - 1/a)). Varies from ${fmtNum(OrbitalFormulas.perihelionVelocity(venusOrbitDistance * currentAUDistance, venusOrbitalEccentricity) * 3600, 0, ',')} km/h at perihelion to ${fmtNum(OrbitalFormulas.aphelionVelocity(venusOrbitDistance * currentAUDistance, venusOrbitalEccentricity) * 3600, 0, ',')} km/h at aphelion`]},
      {label : () => `Radial velocity (vᵣ)`,
       value : [ { v: () => OrbitalFormulas.radialVelocity(venusOrbitDistance * currentAUDistance, venusOrbitalEccentricity, o.venusTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component toward/away from Sun: vᵣ = √(GM/p) × e × sin(ν). Positive = moving away, negative = approaching`]},
      {label : () => `Transverse velocity (vₜ)`,
       value : [ { v: () => OrbitalFormulas.transverseVelocity(venusOrbitDistance * currentAUDistance, venusOrbitalEccentricity, o.venusTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component perpendicular to radius: vₜ = √(GM/p) × (1 + e × cos(ν)). Always positive`]},
      {label : () => `Perihelion velocity (vₚ)`,
       value : [ { v: () => OrbitalFormulas.perihelionVelocity(venusOrbitDistance * currentAUDistance, venusOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Maximum orbital velocity at perihelion: vₚ = √(GM/a) × √((1+e)/(1-e))`]},
      {label : () => `Aphelion velocity (vₐ)`,
       value : [ { v: () => OrbitalFormulas.aphelionVelocity(venusOrbitDistance * currentAUDistance, venusOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Minimum orbital velocity at aphelion: vₐ = √(GM/a) × √((1-e)/(1+e))`]},
      {label : () => `Specific Orbital Energy (ε)`,
       value : [ { v: () => OrbitalFormulas.specificEnergy(venusOrbitDistance * currentAUDistance), dec:4, sep:',' },{ small: 'km²/s²' }],
       hover : [`Total mechanical energy per unit mass: ε = -GM/(2a). Negative for bound orbits`]},
      {label : () => `Specific Angular Momentum (h)`,
       value : [ { v: () => OrbitalFormulas.specificAngularMomentum(venusOrbitDistance * currentAUDistance, venusOrbitalEccentricity), dec:2, sep:',' },{ small: 'km²/s' }],
       hover : [`Angular momentum per unit mass: h = √(GM × a × (1-e²)). Constant throughout orbit`]},
    null,
      {label : () => `Longitude of perihelion (ϖ)`,
    ...
    null,
      ...
      {label : () => `Current orbital velocity`,
       ...
       hover : [`Instantaneous velocity from vis-viva equation: v = √(GM(2/r - 1/a)). Varies from ${fmtNum(OrbitalFormulas.perihelionVelocity(marsOrbitDistance * currentAUDistance, marsOrbitalEccentricity) * 3600, 0, ',')} km/h at perihelion to ${fmtNum(OrbitalFormulas.aphelionVelocity(marsOrbitDistance * currentAUDistance, marsOrbitalEccentricity) * 3600, 0, ',')} km/h at aphelion`]},
      {label : () => `Radial velocity (vᵣ)`,
       value : [ { v: () => OrbitalFormulas.radialVelocity(marsOrbitDistance * currentAUDistance, marsOrbitalEccentricity, o.marsTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component toward/away from Sun: vᵣ = √(GM/p) × e × sin(ν). Positive = moving away, negative = approaching`]},
      {label : () => `Transverse velocity (vₜ)`,
       value : [ { v: () => OrbitalFormulas.transverseVelocity(marsOrbitDistance * currentAUDistance, marsOrbitalEccentricity, o.marsTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component perpendicular to radius: vₜ = √(GM/p) × (1 + e × cos(ν)). Always positive`]},
      {label : () => `Perihelion velocity (vₚ)`,
       value : [ { v: () => OrbitalFormulas.perihelionVelocity(marsOrbitDistance * currentAUDistance, marsOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Maximum orbital velocity at perihelion: vₚ = √(GM/a) × √((1+e)/(1-e))`]},
      {label : () => `Aphelion velocity (vₐ)`,
       value : [ { v: () => OrbitalFormulas.aphelionVelocity(marsOrbitDistance * currentAUDistance, marsOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Minimum orbital velocity at aphelion: vₐ = √(GM/a) × √((1-e)/(1+e))`]},
      {label : () => `Specific Orbital Energy (ε)`,
       value : [ { v: () => OrbitalFormulas.specificEnergy(marsOrbitDistance * currentAUDistance), dec:4, sep:',' },{ small: 'km²/s²' }],
       hover : [`Total mechanical energy per unit mass: ε = -GM/(2a). Negative for bound orbits`]},
      {label : () => `Specific Angular Momentum (h)`,
       value : [ { v: () => OrbitalFormulas.specificAngularMomentum(marsOrbitDistance * currentAUDistance, marsOrbitalEccentricity), dec:2, sep:',' },{ small: 'km²/s' }],
       hover : [`Angular momentum per unit mass: h = √(GM × a × (1-e²)). Constant throughout orbit`]},
    null,
      {label : () => `Longitude of perihelion (ϖ)`,
    ...
    null,
      ...
      {label : () => `Current orbital velocity`,
       ...
       hover : [`Instantaneous velocity from vis-viva equation: v = √(GM(2/r - 1/a)). Varies from ${fmtNum(OrbitalFormulas.perihelionVelocity(jupiterOrbitDistance * currentAUDistance, jupiterOrbitalEccentricity) * 3600, 0, ',')} km/h at perihelion to ${fmtNum(OrbitalFormulas.aphelionVelocity(jupiterOrbitDistance * currentAUDistance, jupiterOrbitalEccentricity) * 3600, 0, ',')} km/h at aphelion`]},
      {label : () => `Radial velocity (vᵣ)`,
       value : [ { v: () => OrbitalFormulas.radialVelocity(jupiterOrbitDistance * currentAUDistance, jupiterOrbitalEccentricity, o.jupiterTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component toward/away from Sun: vᵣ = √(GM/p) × e × sin(ν). Positive = moving away, negative = approaching`]},
      {label : () => `Transverse velocity (vₜ)`,
       value : [ { v: () => OrbitalFormulas.transverseVelocity(jupiterOrbitDistance * currentAUDistance, jupiterOrbitalEccentricity, o.jupiterTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component perpendicular to radius: vₜ = √(GM/p) × (1 + e × cos(ν)). Always positive`]},
      {label : () => `Perihelion velocity (vₚ)`,
       value : [ { v: () => OrbitalFormulas.perihelionVelocity(jupiterOrbitDistance * currentAUDistance, jupiterOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Maximum orbital velocity at perihelion: vₚ = √(GM/a) × √((1+e)/(1-e))`]},
      {label : () => `Aphelion velocity (vₐ)`,
       value : [ { v: () => OrbitalFormulas.aphelionVelocity(jupiterOrbitDistance * currentAUDistance, jupiterOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Minimum orbital velocity at aphelion: vₐ = √(GM/a) × √((1-e)/(1+e))`]},
      {label : () => `Specific Orbital Energy (ε)`,
       value : [ { v: () => OrbitalFormulas.specificEnergy(jupiterOrbitDistance * currentAUDistance), dec:4, sep:',' },{ small: 'km²/s²' }],
       hover : [`Total mechanical energy per unit mass: ε = -GM/(2a). Negative for bound orbits`]},
      {label : () => `Specific Angular Momentum (h)`,
       value : [ { v: () => OrbitalFormulas.specificAngularMomentum(jupiterOrbitDistance * currentAUDistance, jupiterOrbitalEccentricity), dec:2, sep:',' },{ small: 'km²/s' }],
       hover : [`Angular momentum per unit mass: h = √(GM × a × (1-e²)). Constant throughout orbit`]},
    null,
      {label : () => `Longitude of perihelion (ϖ)`,
    ...
    null,
      ...
      {label : () => `Current orbital velocity`,
       ...
       hover : [`Instantaneous velocity from vis-viva equation: v = √(GM(2/r - 1/a)). Varies from ${fmtNum(OrbitalFormulas.perihelionVelocity(saturnOrbitDistance * currentAUDistance, saturnOrbitalEccentricity) * 3600, 0, ',')} km/h at perihelion to ${fmtNum(OrbitalFormulas.aphelionVelocity(saturnOrbitDistance * currentAUDistance, saturnOrbitalEccentricity) * 3600, 0, ',')} km/h at aphelion`]},
      {label : () => `Radial velocity (vᵣ)`,
       value : [ { v: () => OrbitalFormulas.radialVelocity(saturnOrbitDistance * currentAUDistance, saturnOrbitalEccentricity, o.saturnTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component toward/away from Sun: vᵣ = √(GM/p) × e × sin(ν). Positive = moving away, negative = approaching`]},
      {label : () => `Transverse velocity (vₜ)`,
       value : [ { v: () => OrbitalFormulas.transverseVelocity(saturnOrbitDistance * currentAUDistance, saturnOrbitalEccentricity, o.saturnTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component perpendicular to radius: vₜ = √(GM/p) × (1 + e × cos(ν)). Always positive`]},
      {label : () => `Perihelion velocity (vₚ)`,
       value : [ { v: () => OrbitalFormulas.perihelionVelocity(saturnOrbitDistance * currentAUDistance, saturnOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Maximum orbital velocity at perihelion: vₚ = √(GM/a) × √((1+e)/(1-e))`]},
      {label : () => `Aphelion velocity (vₐ)`,
       value : [ { v: () => OrbitalFormulas.aphelionVelocity(saturnOrbitDistance * currentAUDistance, saturnOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Minimum orbital velocity at aphelion: vₐ = √(GM/a) × √((1-e)/(1+e))`]},
      {label : () => `Specific Orbital Energy (ε)`,
       value : [ { v: () => OrbitalFormulas.specificEnergy(saturnOrbitDistance * currentAUDistance), dec:4, sep:',' },{ small: 'km²/s²' }],
       hover : [`Total mechanical energy per unit mass: ε = -GM/(2a). Negative for bound orbits`]},
      {label : () => `Specific Angular Momentum (h)`,
       value : [ { v: () => OrbitalFormulas.specificAngularMomentum(saturnOrbitDistance * currentAUDistance, saturnOrbitalEccentricity), dec:2, sep:',' },{ small: 'km²/s' }],
       hover : [`Angular momentum per unit mass: h = √(GM × a × (1-e²)). Constant throughout orbit`]},
    null,
      {label : () => `Longitude of perihelion (ϖ)`,
    ...
    null,
      ...
      {label : () => `Current orbital velocity`,
       ...
       hover : [`Instantaneous velocity from vis-viva equation: v = √(GM(2/r - 1/a)). Varies from ${fmtNum(OrbitalFormulas.perihelionVelocity(uranusOrbitDistance * currentAUDistance, uranusOrbitalEccentricity) * 3600, 0, ',')} km/h at perihelion to ${fmtNum(OrbitalFormulas.aphelionVelocity(uranusOrbitDistance * currentAUDistance, uranusOrbitalEccentricity) * 3600, 0, ',')} km/h at aphelion`]},
      {label : () => `Radial velocity (vᵣ)`,
       value : [ { v: () => OrbitalFormulas.radialVelocity(uranusOrbitDistance * currentAUDistance, uranusOrbitalEccentricity, o.uranusTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component toward/away from Sun: vᵣ = √(GM/p) × e × sin(ν). Positive = moving away, negative = approaching`]},
      {label : () => `Transverse velocity (vₜ)`,
       value : [ { v: () => OrbitalFormulas.transverseVelocity(uranusOrbitDistance * currentAUDistance, uranusOrbitalEccentricity, o.uranusTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component perpendicular to radius: vₜ = √(GM/p) × (1 + e × cos(ν)). Always positive`]},
      {label : () => `Perihelion velocity (vₚ)`,
       value : [ { v: () => OrbitalFormulas.perihelionVelocity(uranusOrbitDistance * currentAUDistance, uranusOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Maximum orbital velocity at perihelion: vₚ = √(GM/a) × √((1+e)/(1-e))`]},
      {label : () => `Aphelion velocity (vₐ)`,
       value : [ { v: () => OrbitalFormulas.aphelionVelocity(uranusOrbitDistance * currentAUDistance, uranusOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Minimum orbital velocity at aphelion: vₐ = √(GM/a) × √((1-e)/(1+e))`]},
      {label : () => `Specific Orbital Energy (ε)`,
       value : [ { v: () => OrbitalFormulas.specificEnergy(uranusOrbitDistance * currentAUDistance), dec:4, sep:',' },{ small: 'km²/s²' }],
       hover : [`Total mechanical energy per unit mass: ε = -GM/(2a). Negative for bound orbits`]},
      {label : () => `Specific Angular Momentum (h)`,
       value : [ { v: () => OrbitalFormulas.specificAngularMomentum(uranusOrbitDistance * currentAUDistance, uranusOrbitalEccentricity), dec:2, sep:',' },{ small: 'km²/s' }],
       hover : [`Angular momentum per unit mass: h = √(GM × a × (1-e²)). Constant throughout orbit`]},
    null,
      {label : () => `Longitude of perihelion (ϖ)`,
    ...
    null,
      ...
      {label : () => `Current orbital velocity`,
       ...
       hover : [`Instantaneous velocity from vis-viva equation: v = √(GM(2/r - 1/a)). Varies from ${fmtNum(OrbitalFormulas.perihelionVelocity(neptuneOrbitDistance * currentAUDistance, neptuneOrbitalEccentricity) * 3600, 0, ',')} km/h at perihelion to ${fmtNum(OrbitalFormulas.aphelionVelocity(neptuneOrbitDistance * currentAUDistance, neptuneOrbitalEccentricity) * 3600, 0, ',')} km/h at aphelion`]},
      {label : () => `Radial velocity (vᵣ)`,
       value : [ { v: () => OrbitalFormulas.radialVelocity(neptuneOrbitDistance * currentAUDistance, neptuneOrbitalEccentricity, o.neptuneTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component toward/away from Sun: vᵣ = √(GM/p) × e × sin(ν). Positive = moving away, negative = approaching`]},
      {label : () => `Transverse velocity (vₜ)`,
       value : [ { v: () => OrbitalFormulas.transverseVelocity(neptuneOrbitDistance * currentAUDistance, neptuneOrbitalEccentricity, o.neptuneTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component perpendicular to radius: vₜ = √(GM/p) × (1 + e × cos(ν)). Always positive`]},
      {label : () => `Perihelion velocity (vₚ)`,
       value : [ { v: () => OrbitalFormulas.perihelionVelocity(neptuneOrbitDistance * currentAUDistance, neptuneOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Maximum orbital velocity at perihelion: vₚ = √(GM/a) × √((1+e)/(1-e))`]},
      {label : () => `Aphelion velocity (vₐ)`,
       value : [ { v: () => OrbitalFormulas.aphelionVelocity(neptuneOrbitDistance * currentAUDistance, neptuneOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Minimum orbital velocity at aphelion: vₐ = √(GM/a) × √((1-e)/(1+e))`]},
      {label : () => `Specific Orbital Energy (ε)`,
       value : [ { v: () => OrbitalFormulas.specificEnergy(neptuneOrbitDistance * currentAUDistance), dec:4, sep:',' },{ small: 'km²/s²' }],
       hover : [`Total mechanical energy per unit mass: ε = -GM/(2a). Negative for bound orbits`]},
      {label : () => `Specific Angular Momentum (h)`,
       value : [ { v: () => OrbitalFormulas.specificAngularMomentum(neptuneOrbitDistance * currentAUDistance, neptuneOrbitalEccentricity), dec:2, sep:',' },{ small: 'km²/s' }],
       hover : [`Angular momentum per unit mass: h = √(GM × a × (1-e²)). Constant throughout orbit`]},
    null,
      {label : () => `Longitude of perihelion (ϖ)`,
    ...
    null,
      ...
      {label : () => `Current orbital velocity`,
       ...
       hover : [`Instantaneous velocity from vis-viva equation: v = √(GM(2/r - 1/a)). Varies from ${fmtNum(OrbitalFormulas.perihelionVelocity(plutoOrbitDistance * currentAUDistance, plutoOrbitalEccentricity) * 3600, 0, ',')} km/h at perihelion to ${fmtNum(OrbitalFormulas.aphelionVelocity(plutoOrbitDistance * currentAUDistance, plutoOrbitalEccentricity) * 3600, 0, ',')} km/h at aphelion`]},
      {label : () => `Radial velocity (vᵣ)`,
       value : [ { v: () => OrbitalFormulas.radialVelocity(plutoOrbitDistance * currentAUDistance, plutoOrbitalEccentricity, o.plutoTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component toward/away from Sun: vᵣ = √(GM/p) × e × sin(ν). Positive = moving away, negative = approaching`]},
      {label : () => `Transverse velocity (vₜ)`,
       value : [ { v: () => OrbitalFormulas.transverseVelocity(plutoOrbitDistance * currentAUDistance, plutoOrbitalEccentricity, o.plutoTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component perpendicular to radius: vₜ = √(GM/p) × (1 + e × cos(ν)). Always positive`]},
      {label : () => `Perihelion velocity (vₚ)`,
       value : [ { v: () => OrbitalFormulas.perihelionVelocity(plutoOrbitDistance * currentAUDistance, plutoOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Maximum orbital velocity at perihelion: vₚ = √(GM/a) × √((1+e)/(1-e))`]},
      {label : () => `Aphelion velocity (vₐ)`,
       value : [ { v: () => OrbitalFormulas.aphelionVelocity(plutoOrbitDistance * currentAUDistance, plutoOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Minimum orbital velocity at aphelion: vₐ = √(GM/a) × √((1-e)/(1+e))`]},
      {label : () => `Specific Orbital Energy (ε)`,
       value : [ { v: () => OrbitalFormulas.specificEnergy(plutoOrbitDistance * currentAUDistance), dec:4, sep:',' },{ small: 'km²/s²' }],
       hover : [`Total mechanical energy per unit mass: ε = -GM/(2a). Negative for bound orbits`]},
      {label : () => `Specific Angular Momentum (h)`,
       value : [ { v: () => OrbitalFormulas.specificAngularMomentum(plutoOrbitDistance * currentAUDistance, plutoOrbitalEccentricity), dec:2, sep:',' },{ small: 'km²/s' }],
       hover : [`Angular momentum per unit mass: h = √(GM × a × (1-e²)). Constant throughout orbit`]},
    null,
      {label : () => `Longitude of perihelion (ϖ)`,
    ...
    null,
      ...
      {label : () => `Current orbital velocity`,
       ...
       hover : [`Instantaneous velocity from vis-viva equation: v = √(GM(2/r - 1/a)). Varies from ${fmtNum(OrbitalFormulas.perihelionVelocity(halleysOrbitDistance * currentAUDistance, halleysOrbitalEccentricity) * 3600, 0, ',')} km/h at perihelion to ${fmtNum(OrbitalFormulas.aphelionVelocity(halleysOrbitDistance * currentAUDistance, halleysOrbitalEccentricity) * 3600, 0, ',')} km/h at aphelion`]},
      {label : () => `Radial velocity (vᵣ)`,
       value : [ { v: () => OrbitalFormulas.radialVelocity(halleysOrbitDistance * currentAUDistance, halleysOrbitalEccentricity, o.halleysTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component toward/away from Sun: vᵣ = √(GM/p) × e × sin(ν). Positive = moving away, negative = approaching`]},
      {label : () => `Transverse velocity (vₜ)`,
       value : [ { v: () => OrbitalFormulas.transverseVelocity(halleysOrbitDistance * currentAUDistance, halleysOrbitalEccentricity, o.halleysTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component perpendicular to radius: vₜ = √(GM/p) × (1 + e × cos(ν)). Always positive`]},
      {label : () => `Perihelion velocity (vₚ)`,
       value : [ { v: () => OrbitalFormulas.perihelionVelocity(halleysOrbitDistance * currentAUDistance, halleysOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Maximum orbital velocity at perihelion: vₚ = √(GM/a) × √((1+e)/(1-e))`]},
      {label : () => `Aphelion velocity (vₐ)`,
       value : [ { v: () => OrbitalFormulas.aphelionVelocity(halleysOrbitDistance * currentAUDistance, halleysOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Minimum orbital velocity at aphelion: vₐ = √(GM/a) × √((1-e)/(1+e))`]},
      {label : () => `Specific Orbital Energy (ε)`,
       value : [ { v: () => OrbitalFormulas.specificEnergy(halleysOrbitDistance * currentAUDistance), dec:4, sep:',' },{ small: 'km²/s²' }],
       hover : [`Total mechanical energy per unit mass: ε = -GM/(2a). Negative for bound orbits`]},
      {label : () => `Specific Angular Momentum (h)`,
       value : [ { v: () => OrbitalFormulas.specificAngularMomentum(halleysOrbitDistance * currentAUDistance, halleysOrbitalEccentricity), dec:2, sep:',' },{ small: 'km²/s' }],
       hover : [`Angular momentum per unit mass: h = √(GM × a × (1-e²)). Constant throughout orbit`]},
    null,
      {label : () => `Longitude of perihelion (ϖ)`,
    ...
    null,
      ...
      {label : () => `Current orbital velocity`,
       ...
       hover : [`Instantaneous velocity from vis-viva equation: v = √(GM(2/r - 1/a)). Varies from ${fmtNum(OrbitalFormulas.perihelionVelocity(erosOrbitDistance * currentAUDistance, erosOrbitalEccentricity) * 3600, 0, ',')} km/h at perihelion to ${fmtNum(OrbitalFormulas.aphelionVelocity(erosOrbitDistance * currentAUDistance, erosOrbitalEccentricity) * 3600, 0, ',')} km/h at aphelion`]},
      {label : () => `Radial velocity (vᵣ)`,
       value : [ { v: () => OrbitalFormulas.radialVelocity(erosOrbitDistance * currentAUDistance, erosOrbitalEccentricity, o.erosTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component toward/away from Sun: vᵣ = √(GM/p) × e × sin(ν). Positive = moving away, negative = approaching`]},
      {label : () => `Transverse velocity (vₜ)`,
       value : [ { v: () => OrbitalFormulas.transverseVelocity(erosOrbitDistance * currentAUDistance, erosOrbitalEccentricity, o.erosTrueAnomaly) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Velocity component perpendicular to radius: vₜ = √(GM/p) × (1 + e × cos(ν)). Always positive`]},
      {label : () => `Perihelion velocity (vₚ)`,
       value : [ { v: () => OrbitalFormulas.perihelionVelocity(erosOrbitDistance * currentAUDistance, erosOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Maximum orbital velocity at perihelion: vₚ = √(GM/a) × √((1+e)/(1-e))`]},
      {label : () => `Aphelion velocity (vₐ)`,
       value : [ { v: () => OrbitalFormulas.aphelionVelocity(erosOrbitDistance * currentAUDistance, erosOrbitalEccentricity) * 3600, dec:2, sep:',' },{ small: 'km/h' }],
       hover : [`Minimum orbital velocity at aphelion: vₐ = √(GM/a) × √((1-e)/(1+e))`]},
      {label : () => `Specific Orbital Energy (ε)`,
       value : [ { v: () => OrbitalFormulas.specificEnergy(erosOrbitDistance * currentAUDistance), dec:4, sep:',' },{ small: 'km²/s²' }],
       hover : [`Total mechanical energy per unit mass: ε = -GM/(2a). Negative for bound orbits`]},
      {label : () => `Specific Angular Momentum (h)`,
       value : [ { v: () => OrbitalFormulas.specificAngularMomentum(erosOrbitDistance * currentAUDistance, erosOrbitalEccentricity), dec:2, sep:',' },{ small: 'km²/s' }],
       hover : [`Angular momentum per unit mass: h = √(GM × a × (1-e²)). Constant throughout orbit`]},
    null,
      {label : () => `Longitude of perihelion (ϖ)`,
