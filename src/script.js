...
const planetStats = {
    ...
    {header : '—  Position & Anomalies —' },
      {label : () => `Mean Anomaly (M)`,
       ...
       hover : [`Angular position assuming uniform circular motion from perihelion`]},
      {label : () => `Eccentric Anomaly (E)`,
       value : [ { v: () => o.earthEccentricAnomaly, dec:2, sep:',' },{ small: 'degrees (°)' }],
       hover : [`Angle at ellipse center, relates Mean and True anomalies`]},
      ...
      {label : () => `Equation of the Center`,
       ...
       hover : [`Difference between true and mean anomaly: ν - M`]},
    null,
    ...
    null,
      {label : () => `True Anomaly Rate (dν/dt)`,
       ...
       hover : [`Rate of change of true anomaly: fastest at perihelion, slowest at aphelion`]},
    ...
    {header : '—  Time Calculations —' },
      {label : () => `Time since perihelion`,
       ...
       hover : [`Days elapsed since last perihelion passage`]},
      {label : () => `Time to next perihelion`,
       ...
       hover : [`Days until next perihelion passage`]},
