...
- [Milankovitch Framework (Doc 16)](docs/16-milankovitch-language.md), [Empirical Evidence (Doc 17)](docs/17-milankovitch-evidence.md), and [Super-Cycle Test + 14 Follow-Ups + 405-kyr Investigation (Doc 18)](docs/18-8h-super-cycle-test.md) — Spectral analysis of LR04 + Cheng2016 U-Th-dated speleothems + Westerhold 2020 CENOGRID 67-Myr Cenozoic record + EPICA Dome C CO₂. Produces the explicit **8H Orbital Forcing Formula** (25-component fit on LR04, R² = 0.232, forward projection of the next natural glaciation). Identifies the 100-kyr-band empirical centroid as the Mercury–Mars s₁−s₄ nodal beat at 107 kyr (planet-pair orbital-plane coupling); H/3 inclination precession is one theoretical pathway within the broader inclination-side eigenmode family. Doc 18 documents fourteen independent follow-up tests of the framework (16 positive sub-results, two partials, five nulls) plus a dedicated investigation of the empirical 405-kyr cycle — found to sit off the 8H integer-divisor lattice and explained as a carbon-cycle silicate-weathering thermostat resonance rather than a planetary orbital beat
